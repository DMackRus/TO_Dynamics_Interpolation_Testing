...
def main():
    ...
    pandas = pd.read_csv('Data/trainDataInputs_A.csv', header=None)
    loadInputData_A = pandas.to_numpy()

    pandas = pd.read_csv('Data/trainDataOutputs_A.csv', header=None)
    ...
    history = model_A.fit(x=x_train, y=y_train, batch_size=200, epochs=50, validation_data=(x_val, y_val), callbacks = [callback])
    print("MODEL FINISHED TRAINING")

    model_A.save("models/A_model.model")
